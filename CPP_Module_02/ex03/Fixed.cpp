...
/*   Updated: 2024/07/25 15:53:44 by vdomasch         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Fixed::Fixed(const float float_num): number(float_num * (1 << this->bits)) //round used to have same value as example
{
